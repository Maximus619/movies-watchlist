    ...
    <div className='my-container'>
      ...
      <div className='aboutpage '>
        ...
        <div className="shawdow1">
          ...
          <div align="center">
            <div>
              <a href="mailto:anant.gupta619@gmail.com" target="_blank" rel="noreferrer" >
              ...
              <a href="https://www.linkedin.com/in/anantkumargupta/" target="_blank" rel="noreferrer">
              ...
              <a href='https://github.com/maximus619/' target='_blank' rel="noreferrer" >
        ...
        <h5 style={{ textAlign: 'center' }} className="shadow1">Made with <span style={{ color: "#e25555" }}>&hearts;</span> | Coded by Anant Kumar Gupta</h5>
        <hr />
      </div>
    </div>
  )
